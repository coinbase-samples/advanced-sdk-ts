...
export function createOrder(this: RESTBase, client_order_id: string, product_id: string, side: string,
...
export function editOrder(this: RESTBase, order_id: string, price?: string, size?: string){
    let bodyParams = {
        order_id: order_id,
        price: price,
        size: size
...
export function editOrderPreview(this: RESTBase, order_id: string, price?: string, size?: string){
    let bodyParams = {
        order_id: order_id,
        price: price,
        size: size
...
export function listOrders(this: RESTBase, order_ids?: string[], product_ids?: string[],
                           order_status?: string[], limit?: number, start_date?: string,
                           end_date?: string, order_type?: string, order_side?: string, cursor?: string,
                           product_type?: string, order_placement_source?: string, contract_expiry_type?: string,
...
export function listFills(this: RESTBase, order_ids?: string[], trade_ids?: string[] ,product_ids?: string[], start_sequence_timestamp?: string,
...
export function previewOrder(this: RESTBase, product_id: string, side: string, commission_rate: object,
