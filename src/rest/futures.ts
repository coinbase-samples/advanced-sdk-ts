...
export function closePosition(this: RESTBase, client_order_id: string, product_id: string,
    size?: string){
    let bodyParams = {
...
export function setIntradayMarginSetting(this: RESTBase, intraday_margin_setting?: string){
    let bodyParams = {
...
export function getCurrentMarginWindow(this: RESTBase, margin_profile_type?: string){
    let bodyParams = {
